                ...
                <div className="container mx-auto h-auto grid grid-cols-5 gap-8">
                    <div className="w-full h-full bg-white px-4 col-span-4">
                        ...
                        <div onClick={()=>dispatch(resetCart())} className="w-full py-2">
                            <button className="px-10 p-2 bg-red-500 hover:bg-red-600 text-white rounded-lg font-titleFont font-semibold text-lg tracking-wide active:bg-red-500">
                                Clear Cart
                            </button>
                        </div>
                    </div>
                    <div className="w-full h-52 bg-white col-span-1 flex flex-col justify-center p-4">
                            <div>
                                <p className="flex gap-2 items-start text-sm">
                                    <span>
                                        <CheckCircleOutlineIcon className="bg-white text-green-500 rounded-full" />
                                    </span>{" "}
                            ...
                            <button className="w-full font-titleFont font-medium text-base bg-gradient-to-tr from-yellow-400 to-yellow-200 border hover:from-yellow-300 hover:to-yellow-300 border-yellow-500 hover:border-yellow-700 active:bg-gradient-to-bl active:from-yellow-400 active:to-yellow-500 duration-200 py-1.5 rounded-md mt-2 ">Proceed To Pay</button>
                    </div>
                </div>
            ):(
            <motion.div
             ...
             className="flex justify-center items-center gap-4 py-10">
                ...
                <div className="w-96 p-4 bg-white flex flex-col items-center rounded-md shadow-lg">
                    ...
                    <Link to="/">
                        <button className="mt-6 bg-yellow-400 rounded-md cursor-pointer hover:bg-yellow-500  font-titleFont font-semibold text-bas active:bg-yellow-700 px-8 py-2 text-lg ">Continue Shopping</button>
                    </Link>
                </div>  
            </motion.div>
